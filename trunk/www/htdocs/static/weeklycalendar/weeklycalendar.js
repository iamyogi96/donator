...
var w_d = new Date()
var w_monthname=new Array("Januar","Februar","Marc","April","Maj","Junij","Julij","Avgust","September","Oktber","November","December");
var w_dayname = new Array("Ned","Pon","Tor","Sre","Cet","Pet","Sob");
var w_StartOfWeek = 1; // Monday

// image title
var prev_month_title = "Predhodni mesec";
var next_month_title = "naslednji mesec";
var close_title = "Zapri";
...
function w_displayCal()
{
	...
	{
		document.getElementById('weeklyCalendar').style.left=gx - 190;
...
function w_writeDayname()
{
    ...
    document.write('<td class="week" id="weekHeader">Teden</td>');
...
function buildWeeklyCalendar(WeekStart)
{
    ...
    document.write('<tr class="firstrow"><td width="8px" onClick="w_renderCalendar(-1);" align="right" ><img src="/static/weeklycalendar/arrow_left.gif" title="' + prev_month_title + '" border="0"></td>');
    document.write('<td width="8px" onClick="w_renderCalendar(1);" align="left" ><img src="/static/weeklycalendar/arrow_right.gif" title="' + next_month_title + '" border="0"></td>');
    ...
    document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="/static/weeklycalendar/close.jpg" title="' + close_title + '" border="0"></td>');
